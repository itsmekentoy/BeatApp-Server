...
class AttendanceListener extends Command
{
    ...
    protected $description = 'Listen for attendance device UDP packets';
    ...
    public function handle()
    {
        ...
        $this->info("✅ Listening for attendance UDP packets on port {$port}...");
        ...
        while (true) {
            ...
            if ($bytes > 0) {
                ...
                // Prevent same-card duplicate tap
